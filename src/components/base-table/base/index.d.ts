...
export type CallOrReturn<T, P = any[]> =
  | T
  | (P extends any[] ? (...p: P) => T : (p: P) => T);
...
export default class BaseTable<T = unknown> extends React.Component<
  BaseTableProps<T>,
  any
> {
...
export function callOrReturn<T, P extends any[] = any[]>(
  funcOrValue: CallOrReturn<T, P>,
  ...args: P
): T;
